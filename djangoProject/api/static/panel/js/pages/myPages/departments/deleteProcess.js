...
$(document).ready(function () {
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        LINK.href = '/panel/departments/delete/' + idTypeOfStudent + '/';
        const modal = $(this);
        modal.find('.modal-body-text').text('¿Seguro que desea eliminar el tipo de departamento ' + typeOfStudent.toUpperCase() + '?')
    })
});