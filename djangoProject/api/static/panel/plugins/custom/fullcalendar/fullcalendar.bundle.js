    ...
    function parseSingle(raw, allDayDefault, calendar, leftovers, allowOpenRange) {
        ...
        if (allDay == null) {
            if (allDayDefault != null) {
                ...
                // fall panelViews to the date props LAST
    ...
    function buildViewSpec(viewDef, overrideConfigs, optionsManager) {
        ...
        return {
            ...
            buttonTextDefault: queryButtonText(optionsManager.localeDefaults) ||
                ...
                viewDef.type // fall panelViews to given view name
        };
    }
    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype.computeLabelInterval = function (slotDuration) {
            ...
            return slotDuration; // fall panelViews
        };
        /* Rendering
        ------------------------------------------------------------------------------------------------------------------*/
    ...
    var AbstractTimeGridView = /** @class */ (function (_super) {
        ...
        AbstractTimeGridView.prototype.updateBaseSize = function (isResize, viewHeight, isAuto) {
            ...
            // reset all dimensions panelViews to the original state
